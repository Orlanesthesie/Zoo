...
$animals = $animalManager->getAnimalsBySpecies('eagle');
...
<div class="row">
    <div class="col-2 marron-blur">
        ...
        <?php foreach ($animals as $key => $animal) { ?>
            <!-- <img src="./assets/images/eagle.png" class="img-eagle" style="left:<?= $key * 90 + 1000 ?>px; top:75%"> -->
        <?php } ?>
        ...
        <!-- MODALE ADD -->
        <h3 class="text-center mt-5"><a href="#openModal">Add an owl</a></h3>
        <?php if (count($animals) <= 3) { ?>
            <div id="openModal" class="modalDialog">
                <div>
                    <a href="#close" title="Close" class="close">X</a>
                    <h2 class="text-center">Let's add an owl !</h2>
                    <p> Kindly specify the rescued owl's name, weight, size, age, and gender.</p>
                    <form action="./process/process_add_animal.php" method="post">
                        ...
                        <input type="hidden" name="species" id="species" value="eagle">
        ...
        <?php } else { ?>
            <div id="openModal" class="modalDialog">
                <div>
                    <a href="#close" title="Close" class="close">X</a>
                    <h2 class="text-center">Let's add an owl !</h2>
                    <p> There are already too many owls. Release one before adding another.</p>
                </div>
                <a href="#close" title="Close" class="close">x</a>
            </div>
        <?php } ?>
        ...
        <!-- MODALE DELETE -->
        <h3 class="text-center mt-5"><a href="#openModal1">Release an owl</a></h3>
        <?php if (count($animals) !== 0) { ?>
            <div id="openModal1" class="modalDialog">
                <div>
                    <a href="#close" title="Close" class="close">X</a>
                    <h2>Let's release an owl !</h2>
                    ...
                    <form action="./process/process_delete_animal.php" method="post">
                        <select name="id" id="pet-select">
                            <option value=""> Please choose an owl </option>
                            <?php foreach ($animals as $key => $animal) { ?>
        ...
        <?php } else { ?>
            <div id="openModal1" class="modalDialog">
                <div>
                    <a href="#close" title="Close" class="close">X</a>
                    <h2 class="text-center">Let's release an owl !</h2>
                    <p> All the owls have been released back into the wild !</p>
                </div>
                <a href="#close" title="Close" class="close">x</a>
            </div>
        <?php } ?>
    ...
    <div class="col-10 p-0">
        ...
        <div class="corps-forest p-0 ">
            <img src="./assets/images/night-forest.jpg" class="img-forest">
            <div class="d-flex justify-content-around align-items-end">
                <?php foreach ($animals as $key => $animal) { ?>
                    <div class="card " style="width: 18rem;">
                        <img class="card-img-top" src="./assets/images/chouette-cute.png" alt="Card image cap">
                        <div class="card-body">
